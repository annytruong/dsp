...
>> Assuming that the number of boy twins and girl twins are equal, the probability that Elvis was a twin is 45%.
...
>> Data in Bayesian statistics is fixed vs. parameters are fixed in frequentists.
