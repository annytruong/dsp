...
>> The probability that Elvis was an identical twin is 5/11, or 45%, assuming the number of boy twins and girl twins are equal.
...
>> The data from Bayesian statistics is fixed vs. parameters are fixed in frequentist.
